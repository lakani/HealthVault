...
namespace HealthVault.Entity.Context
{
    public partial class HealthvaultContext : DbContext
    {
        ...
        public virtual DbSet<MeaslesCase> MeaslesCase { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<MeaslesCase>(entity =>
            {
                entity.HasKey(e => e.CaseID);

                entity.Property(e => e.BirthDate).HasColumnType("date");

                entity.Property(e => e.Date_of_investigation).HasColumnType("date");

                entity.Property(e => e.Date_samplecollected).HasColumnType("date");

                entity.Property(e => e.Datelabreportback).HasColumnType("date");

                entity.Property(e => e.Dateoflast_vaccination).HasColumnType("date");

                entity.Property(e => e.Dateofonset).HasColumnType("date");

                entity.Property(e => e.Datesenttolab).HasColumnType("date");

                entity.Property(e => e.Destination_of_travel).HasMaxLength(10);

                entity.Property(e => e.EPI_ID).HasMaxLength(50);
                ...
                entity.Property(e => e.Reason_Sample_Sent2RL).HasMaxLength(50);

                entity.Property(e => e.Sub_Organization).HasMaxLength(50);

                entity.Property(e => e.Type1stTest).HasMaxLength(50);

                entity.Property(e => e.measles_date_sent_genotyping).HasColumnType("date");

                entity.Property(e => e.rubella_date_sent_genotyping).HasColumnType("date");
            });
